...
const MyOrdersCard = () => {
    ...
    return (
        <div className={styles.MyOrdersCard}>
            ...
            { isOpen !== 1 &&
                <div onClick={() => setIsOpen(1)} className={styles.card}>
                    <span className={styles.triangle + ' icon icon-triangle'}></span>
            ...
            {isOpen === 1 &&
                <div onClick={() => setIsOpen(0)} className={styles.cardInfo}>
                    <span className={styles.triangleTop + ' icon icon-triangle'}></span>
